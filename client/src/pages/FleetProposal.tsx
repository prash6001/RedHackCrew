...
import { Download, Printer, Mail, Calendar, DollarSign, Shield, CheckCircle, FileImage } from 'lucide-react';
...
const FleetProposal = () => {
  ...
  const generatePDF = () => {
    ...
    setTimeout(() => {
      alert('PDF proposal has been generated and will be downloaded shortly.');
    }, 1000);
  };
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Fleet Management Proposal</h1>
            <p className="text-lg text-gray-600 mt-2">Project: {projectDetails.name}</p>
          ...
          <div className="flex space-x-3">
            <button
              onClick={generatePDF}
              className="inline-flex items-center px-4 py-2 bg-[#e30613] text-white rounded-lg hover:bg-red-700 transition-colors"
            >
      ...
      {/* Contract Options */}
      <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
        <h2 className="text-2xl font-bold text-gray-900 mb-6">Fleet Contract Options</h2>
          ...
          {contractTerms.map((term, index) => (
            ...
            >
              ...
              <div className="text-center mb-4">
                <h3 className="text-xl font-bold text-gray-900 mb-2">{term.duration}</h3>
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium text-green-600">{term.savings}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">Total Contract:</span>
                  <span className="font-bold">
                    ${((term.monthlyRate * parseInt(term.duration)) + term.setupFee).toLocaleString()}
                  </span>
                </div>
              </div>
      ...
      {/* Service Inclusions */}
      <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
        <h2 className="text-2xl font-bold text-gray-900 mb-6">Complete Service Package</h2>
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-gray-50 rounded-lg p-6">
            <h3 className="text-lg font-semibold text-gray-800 mb-4">Fleet Management Benefits</h3>
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Fixed monthly payments with no surprises</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Always access to newest tools and features</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
      ...
      <div className="bg-white rounded-xl shadow-lg p-8">
        <h2 className="text-2xl font-bold text-gray-900 mb-6">Recommended Fleet Summary</h2>
      ...
      <div className="bg-gray-50 rounded-xl p-8 mt-8">
        <h2 className="text-2xl font-bold text-gray-900 mb-4">Fleet Proposal Summary</h2>
        <p className="text-gray-600 mb-6">
          This comprehensive fleet analysis has been prepared for your construction project. 
          Our consultant will review these recommendations with you to finalize the optimal fleet configuration.
        </p>
        <div className="bg-white p-6 rounded-lg border-l-4 border-[#e30613]">
          <h3 className="font-semibold text-gray-900 mb-2">Next Steps</h3>
          <div className="text-sm text-gray-700 space-y-1">
            <p>• Review detailed tool recommendations with your Hilti consultant</p>
            <p>• Customize fleet configuration based on specific project needs</p>
