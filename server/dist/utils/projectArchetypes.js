...
export const RESIDENTIAL_ARCHETYPE = {
...
export const COMMERCIAL_ARCHETYPE = {
...
export const INDUSTRIAL_ARCHETYPE = {
...
export const TOOL_PRIORITY_MATRIX = {
    // Hand Tools
...
export const getArchetypeTools = (archetype) => {
    switch (archetype) {
        case 'residential':
...
export const getToolNecessity = (toolName, archetype) => {
...
const findClosestToolMatch = (toolName) => {
...
export const getArchetypeQuantityMultiplier = (archetype, laborCount) => {
...
export const getArchetypeJustification = (toolName, archetype, necessity) => {
...
//# sourceMappingURL=projectArchetypes.js.map