...
export const calculateProjectMetrics = (projectData, recommendations) => {
    ...
    const baseProductivity = projectTypeMultipliers[projectData.projectType] || 0.25;
    ...
    const laborSavings = Math.round(totalProjectHours * averageHourlyLabor * productivityIncrease);
...
export const generateAccurateFleetContract = (projectData, recommendations) => {
...
export const calculateToolROI = (tool, projectData) => {
    ...
    const productivityGain = categoryProductivityGains[tool.category] || 0.20;
...
export const calculateFleetPricing = (basePrice, projectData, toolCategory) => {
...
//# sourceMappingURL=accurateCalculations.js.map